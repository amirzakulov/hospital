 ...
 */
$config['site_title']                 = "Hospital ZM";       // Site Title, example.com
$config['admin_email']                = "amirzakulov@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'patients';           // Default group, use name
$config['admin_group']                = 'administrators';             // Default administrators group, use name
