...
<div class="profile-tabs">
    <ul class="nav nav-tabs nav-tabs-bottom">
        <li class="nav-item"><a class="nav-link active" href="#uzi" data-toggle="tab">УЗИ</a></li>
    </ul>

    <div class="tab-content">
        <div class="tab-pane show active" id="uzi">
            <div class="row">
                <div class="col-md-6">
                    <div class="card-box" style="min-height: 15rem;">
                        <?php foreach ($uzis as $uzi) {?>
                            <div class="card-title float-left"><span class="fa fa-calendar"></span> <?= date("d.m.Y", strtotime($uzi[0]["payment_date"])); ?> </div>
                            <div class="clearfix"></div>
                            <div>
                                <ul>
                                    <?php foreach ($uzi as $u) {?>
                                        <li><?= $u["name"]; ?></li>
                                    <?php }?>
                                </ul>
                            </div>
