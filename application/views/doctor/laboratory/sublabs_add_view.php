...
<div class="row">
    ...
    <div class="col-lg-7">
        ...
        <div class="m-t-20 text-center">
            ...
            <button class="btn btn-primary submit-btn" tabindex="5" name="renew" value="renew"><?= lang("laboratory_save_renew_button") ?></button>
            <a role="button" class="btn btn-secondary submit-btn" tabindex="5" href="<?= site_url("admin/laboratory/sublabs/".$laboratory["id"]) ?>"><?= lang("laboratory_cancel_button") ?></a>
        </div>
        <?= form_close(); ?>
    </div>
