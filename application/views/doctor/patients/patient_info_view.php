            ...
            <div class="profile-view">
                <div class="profile-basic1">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="personal-info">
                                <li><?= $patient["user_description"] ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="tab-content">
        <div class="tab-pane show active" id="laboratory">
            <div class="row">
                <div class="col-md-4">
                    <div class="card-box">
                        <span class="time font-18"><?= date("d.m.Y", strtotime($patient["created_date"])); ?></span><hr>
                        <strong>Бемор шикояти</strong>
                        <p><?= $patient["patient_complaint"]; ?></p>

                        <strong>Anamnesis morbi</strong>
                        <p><?= $patient["anamnesis_morbi"]; ?></p>

                        <strong>Anamnesis vitae</strong>
                        <p><?= $patient["anamnesis_vitae"]; ?></p>

                        <strong>Status praesens</strong>
                        <p><?= $patient["status_praesens"]; ?></p>
