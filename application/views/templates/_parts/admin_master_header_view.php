...
<!--    <link href="--><?//= site_url("assets/fonts/icon.css") ?><!--" rel="stylesheet">-->
    ...
    <?= $before_themeStyle;?>
    <link href="<?= site_url("assets/admin/css/theme-style.css?".time()) ?>" rel="stylesheet">
    <link href="<?= site_url("assets/admin/styles.css?".time()) ?>" rel="stylesheet">
    <link rel="stylesheet" type="text/css" media="print" href="<?= site_url("assets/admin/print-style.css?".time()) ?>">
    <!--[if lt IE 9]>
        ...
        <div class="header">
			...
			<ul class="nav user-menu float-right">
                <li class="nav-item dropdown d-none d-sm-block">
                    ...
                    <div class="dropdown-menu1 notifications1 d-none">
                ...
                <li class="nav-item dropdown has-arrow">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="<?= site_url("admin/user/profile"); ?>">Менинг профилим</a>
                        <a class="dropdown-item" href="<?= site_url("admin/settings"); ?>">Созламалар</a>
                        <a class="dropdown-item" href="<?= site_url("admin/user/logout") ?>"><?= lang("general_logout") ?></a>
                    </div>
                </li>
            </ul>
			-->
