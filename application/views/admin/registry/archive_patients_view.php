            ...
            <table class="table table-border table-striped custom-table datatable_patients mb-0 compact">
                ...
                <?php foreach ($patients as $patient) {?>
                    <tr id="js_row_<?= $patient["id"] ?>">
                        ...
                        <td>
                            <a href="<?= site_url("admin/registry/profile/".$patient["id"]."/archive") ?>"><?= $patient["last_name"] ." ". $patient["first_name"] ." ". $patient["surname"];?></a>
                        ...
                        <td><a href="<?= site_url("admin/registry/add_items/".$patient["id"]) ?>" class="">Янги тўлов</a></td>
                        <td class="text-right">
                            <div class="dropdown dropdown-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="<?= site_url("admin/registry/edit/".$patient["id"]."/archive"); ?>"><i class="fa fa-pencil m-r-5"></i> <?= lang("general_edit"); ?></a>
                                    <a class="dropdown-item js_delele_patient" href="javascript:void(0);" data-href="<?= site_url("admin/registry/delete/") ?>" data-patient-id="<?= $patient["id"] ?>"><i class="fa fa-trash-o m-r-5"></i> <?= lang("general_delete"); ?></a>
                                </div>
                            </div>
                        </td>
                    </tr>
