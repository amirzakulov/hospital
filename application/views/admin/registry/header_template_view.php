<div class="row">
    ...
    <div class="col-sm-3 col-3 text-right m-b-20">
		...
		<div class="btn-group">
			<button type="button" class="btn btn-danger js_show_doctors" title="Шифокорлар" data-url="<?= site_url("admin/registry/ajax_show_doctors_bills") ?>" data-url-cash="<?= site_url("admin/registry/ajax_get_cash_today") ?>"><span class="fa fa-book"> Ш</span></button>
			<button type="button" class="btn btn-danger js_show_partners border-left" title="Хамкорлар" data-url="<?= site_url("admin/registry/ajax_show_partners_bills") ?>" data-url-cash="<?= site_url("admin/registry/ajax_get_cash_today") ?>"><span class="fa fa-book"> Х</span></button>
			<button type="button" class="btn btn-danger js_show_cash_expenses border-left" title="Чиқимлар" data-url="<?= site_url("admin/registry/ajax_show_expenses") ?>" data-url-cash="<?= site_url("admin/registry/ajax_get_cash_today") ?>"><span class="fa fa-book"> Ч</span></button>
