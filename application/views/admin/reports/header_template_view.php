...
<div class="row mb-4">
	<div class="col-md-12">
        <div class="card-box">
            <ul class="nav nav-tabs nav-tabs-solid nav-justified nav-justified--block my_nav_tabs border-bottom border-info"
				data-start-date="<?= $start_date_param; ?>"
				data-end-date="<?= $end_date_param; ?>">
                <li class="nav-item">
                    <a class="js_report_tab nav-link show cursor-pointer <?= ($this->uri->segment(3) == "" || $this->uri->segment(3) == "index") ? "active":"" ?>" data-href="<?= site_url("admin/reports/ajax_cash"); ?>">Касса</a>
                </li>
                <li class="nav-item">
                    <a class="js_report_tab nav-link show cursor-pointer <?= ($this->uri->segment(2) == "reports" && $this->uri->segment(3) == "doctors") ? "active":"" ?>" data-href="<?= site_url("admin/reports/ajax_doctors") ?>">Шифокорлар</a>
                </li>
                <li class="nav-item">
                    <a class="js_report_tab nav-link show cursor-pointer <?= ($this->uri->segment(2) == "reports" && $this->uri->segment(3) == "laboratory") ? "active":"" ?>" data-href="<?= site_url("admin/reports/ajax_laboratory"); ?>">Лаборатория</a>
                </li>
                <li class="nav-item">
					<a class="js_report_tab nav-link show cursor-pointer <?= ($this->uri->segment(2) == "reports" && $this->uri->segment(3) == "uzi") ? "active":"" ?>" data-href="<?= site_url("admin/reports/ajax_uzi"); ?>">УЗИ</a>
                </li>
				<li class="nav-item">
					<a class="js_report_tab nav-link show cursor-pointer <?= $this->uri->segment(3) == "services" ? "active":"" ?>" data-href="<?= site_url("admin/reports/ajax_services") ?>">Қ.Хизматлар</a>
				</li>
				<li class="nav-item">
					<a class="js_report_tab nav-link show cursor-pointer <?= ($this->uri->segment(2) == "reports" && $this->uri->segment(3) == "room") ? "active":"" ?>" data-href="<?= site_url("admin/reports/ajax_room"); ?>">Ётоқ</a>
                </li>
				<li class="nav-item">
					<a class="js_report_tab nav-link show cursor-pointer <?= $this->uri->segment(3) == "expenses" ? "active":"" ?>" data-href="<?= site_url("admin/reports/ajax_expenses") ?>">Чиқимлар</a>
                </li>
				<li class="nav-item d-none">
					<a class="js_report_tab nav-link show cursor-pointer <?= $this->uri->segment(3) == "doctors_bill" ? "active":"" ?>" data-href="<?= site_url("admin/reports/ajax_doctors_bill") ?>">Шифокорларга</a>
                </li>
				<li class="nav-item">
