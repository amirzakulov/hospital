<div class="row">
    ...
    <div class="col-sm-8 col-9 text-right m-b-20">
        <a class="btn btn-primary" href="<?= site_url("admin/rooms/add") ?>" title="<?= lang("rooms_add") ?>" role="button"><span class="fa fa-plus"></span></a>
    </div>
</div>
                        ...
                        <td class="text-right">
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="<?= site_url("admin/rooms/edit/".$room["id"]) ?>"><i class="fa fa-pencil m-r-5"></i> <?= lang("general_edit"); ?></a>
                                    <a class="dropdown-item js_delele_item" href="javascript:void(0);" data-href="<?= site_url("admin/rooms/delete/") ?>" data-id="<?= $room["id"] ?>"><i class="fa fa-trash-o m-r-5"></i> <?= lang("general_delete"); ?></a>
                                </div>
                            </div>
                        </td>
                    </tr>
