    ...
    <div class="col-lg-10 offset-lg-1">
        <?= form_open_multipart("", array("class"=>"needs-validation ".$was_validated, "novalidate"=>"")); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <?php echo lang('create_user_doctor_price_label', 'price', array(), true);?>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <?php echo lang('create_user_doctor_percent_label', 'agreement', array(), true);?>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <?= form_dropdown($groups, $group_options); ?>
                                            <div class="invalid-feedback"><?= form_error('group_id'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            <?php echo lang('create_user_doctors_types_label', 'doctors_types', array(), true);?>
                                            <?= form_dropdown($doctors_types, $doctors_types_options); ?>
            ...
            <div class="m-t-20 text-center">
                ...
                <a role="button" class="btn btn-secondary submit-btn" href="<?= site_url("admin/doctors") ?>"><?= lang("user_cancel_button") ?></a>
            </div>
        <?= form_close(); ?>
    </div>
</div>
