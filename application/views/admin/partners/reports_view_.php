        ...
        <table class="table table-bordered table-striped datatable mb-0 table-small">
			...
			<tr class="js_row_<?=$partner["partner_id"]; ?>">
				...
				<td class="text-right js_current_month_salary">
					<span>
					<?= !empty(isset($partners_income[$partner["partner_id"]]["bill_amount"])) ? money_formatting($partners_income[$partner["partner_id"]]["bill_amount"]) : 0; ?>
					</span>
...
<!--				<td>--><?//= money_formatting($total_income); ?><!--</td>-->
				<td class="js_bill_amount_total"><?= money_formatting($total_amount); ?></td>
				<td></td>
			</tr>
			</tfoot>
        </table>
