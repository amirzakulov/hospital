                            ...
                            <div class="form-group gender-select!">
                                ...
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" name="gender" value="1" <?= set_checkbox('gender', '1', ($partner["gender"] == 1 ? TRUE:FALSE)); ?> class="form-check-input">Эркак
                                    </label>
                                </div>
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" name="gender" value="2" <?= set_checkbox('gender', '2', ($partner["gender"] == 2 ? TRUE:FALSE)); ?> class="form-check-input">Аёл
                                    </label>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group">
										...
										<?= form_dropdown($region, $region_options, $partner["region_id"]); ?>
                                ...
                                <div class="col-sm-4">
									...
									<?= form_dropdown($city, $city_options, $partner["city_id"]); ?>
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <?= form_dropdown($type, $type_options, $partner["type"]); ?>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group mt-3">
										...
										<div class="form-check-inline">
											<label class="form-check-label">
												<input type="radio" name="active" <?= $partner["active"] ? 'checked':''; ?> value="1" class="form-check-input">Фаол
											</label>
										</div>
										<div class="form-check-inline">
											<label class="form-check-label">
												<input type="radio" name="active" <?= !$partner["active"] ? 'checked':''; ?> value="0" class="form-check-input">Нофаол
											</label>
										</div>
									</div>
								</div>
