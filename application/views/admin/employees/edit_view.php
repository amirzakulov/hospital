                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <?= form_radio($gender_male, 1, set_checkbox('gender', 1, ($employee["gender"] == 1 ? true:false)), "id='gender_male'") ?>
                                    <label class="form-check-label" for="gender_male"><?= lang("create_user_gender_male_label") ?></label>
                                </div>
                                <div class="form-check">
                                    <?= form_radio($gender_female, 2, set_checkbox('gender', 2, ($employee["gender"] == 2 ? true:false)), "id='gender_female'") ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <?= form_dropdown($departments, $department_options, $employee["department_id"]); ?>
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <?= form_dropdown($job_title, $job_titles_options, $employee["job_title_id"]); ?>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?= form_dropdown($groups, $groups_options, $employee["group_id"]); ?>
                                        <div class="invalid-feedback"><?= form_error('groups'); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
