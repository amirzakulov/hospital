...
$(document).ready(function($) {
    ...
    if($(".sidebar-menu .submenu ul li.active").length > 0)
    {
        $(".sidebar-menu .submenu ul li.active").closest("ul").show();
    ...
    if($('.datatable_patients').length > 0) {
	...
	if($('.datatable_order_desc').length > 0) {
		$('.datatable_order_desc').DataTable({
			"bFilter": false,
			"searching": true,
			"ordering": true,
            "order": [[ 0, "desc" ]],
